...
- Real MyDigital ID SSO
- Real PADU integration
- Agency API connections for SARA, STR or BUDI95
- Real eligibility, balances, usage or transactions
- Live PriceCatcher adapter or Jualan Rahmah event feed
...
- MyDigital ID relying-party onboarding
- Accessibility testing with OKU users, caregivers, elderly citizens and low-literacy users
- Human support, correction and dispute operating procedures
